...
## ----size_evidence------------------------------------------------------------
dim(xpevi)
format(object.size(xpevi), units="Mb")
...
## ----protein_detection--------------------------------------------------------
head(xpprodat$detect)

## ----missing_condition--------------------------------------------------------
only.1112 <- which(xpprodat$detect$`1112` & !xpprodat$detect$BMO)
only.BMO <- which(!xpprodat$detect$`1112` & xpprodat$detect$BMO)

## ----missing_condition_proteins-----------------------------------------------
as.character(xpprodat$proteins[only.1112])
