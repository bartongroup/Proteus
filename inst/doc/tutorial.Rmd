...
The function `plotIntensityDistributions` can be used to compare intensity distributions for each normalization.

```{r, intensity_distributions_1, fig.width=5, fig.height=4}
plotIntensityDistributions(prodat, title="Not normalized", fill="condition")
```

```{r, intensity_distributions_2, fig.width=5, fig.height=4}
plotIntensityDistributions(prodat.med, title="Median normalization", fill="condition")
```

```{r, intensity_distributions_3, fig.width=5, fig.height=4}
plotIntensityDistributions(prodat.quant, title="Quantile normalization", fill="condition")
```
