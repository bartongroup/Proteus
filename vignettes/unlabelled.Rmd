...
Here is a minimal example of data analysis in *Proteus*. You will need an evidence file from *MaxQuant* and a very simple text file with metadata  (see below how to create it). Then, you can get from the evidence file to differential expression in just a few steps.
