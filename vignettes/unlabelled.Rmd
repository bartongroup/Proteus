...
This tutorial demonstrates how to analyse data from unlabelled MS/MS experiment in *Proteus*.
...
plotIntensities(xpprodat.med, id='sp|P26263|PDC6_YEAST', log=TRUE)
```
